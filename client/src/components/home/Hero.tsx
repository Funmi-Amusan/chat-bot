...
export const Hero = () => {
  return (
    ...
    >
      <Navbar />
      <div className=" container py-16 flex-col-center flex-col justify-center text-center">
     ...
     <Image src={ImageAssets.cursor.src} alt="cursor image" aria-hidden className="absolute top-10 -left-12 hidden md:block"  width={150} height={150} />
     <Image src={ImageAssets.message.src} alt="message image" aria-hidden className="absolute top-20 -right-15 hidden md:block"  width={150} height={150} />
