...
export const ProductShowcase = () => {
  return (
    <section className="bg-gradient-to-b from-black from-20%  to-[#5D2CA8] to-90%  px-4 py-12 gap-6 flex-center-col">
      ...
      <Image src={ImageAssets.appScreen} alt="Logo" className='w-full h-full object-cover ' width={500} height={500}/>
    </section>
  );
};
