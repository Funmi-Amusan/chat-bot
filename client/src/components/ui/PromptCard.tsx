  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-between w-full'>
        <p className='text-black/50 dark:text-white/50 text-sm text-start flex-1 transition-all group-hover:text-black/70 dark:group-hover:text-white/70'>{content}</p>
