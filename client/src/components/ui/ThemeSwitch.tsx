      ...
      <label htmlFor="theme-switch" className="relative inline-block w-14 h-8 cursor-pointer ">
        ...
        <span 
          className={`absolute transition-all duration-500 ${
            isChecked 
              ? ''
              : 'h-0.5 w-0.5 rounded-full right-[20%] top-[15%] bg-yellow-800 shadow-[-7px_10px_0_#e5f041e6,_8px_15px_0_#e5f041e6,_-17px_1px_0_#e5f041e6,_-20px_10px_0_#e5f041e6,_-7px_23px_0_#e5f041e6,_-15px_25px_0_#e5f041e6]'
          }`}
        ></span>
      </label>
    </div>
